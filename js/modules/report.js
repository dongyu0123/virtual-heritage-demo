...
const Report = (() => {
  ...
  function show() {
    ...
    let html = `
      ...
      <h3>一、文物基本信息</h3>
      <p>详见全息档案。主要参数：商末周初青铜食器鼎，通高38.2cm，口径28.6cm，一级文物，传世收藏。</p>

      <h3>二、裂缝发展分析</h3>
      <p>核心裂缝(#03)位于腹部正前方，2019年初始长度3.2cm，至2024年已扩展至12.4cm，年均增长约1.8cm。2022年雨季为关键加速期（单年增长4.4cm），与环境湿度持续超标（72%RH）高度相关。</p>
