...
const MockData = {
  ...
  artifact: {
    ...
    weight: '4.7kg',
    origin: '陕西省宝鸡市茹家庄西周墓出土',
    collection: '陕西省文物院',
    description: '该鼎为西周中期典型礼器，口沿外侈，双立耳，三柱足。腹部饰兽面纹，以云雷纹为地，纹饰精美，铸造工艺精湛。器身保存基本完整，腹部见多处裂缝与腐蚀病害，需进行保护性修复。',
    history: '1974年出土于宝鸡茹家庄西周墓地，1980年经修复后入藏。2019年例行检测发现腹部裂缝延伸，2022年雨季裂缝加剧扩展，需重新评估修复方案。'
  },

  /* ====== 损伤数据 ====== */
  damages: [
    { id: 'D01', name: '裂缝 #01', type: '裂缝', position: '腹部左侧', level: 'moderate', color: '#f59e0b', length: 8.6, width: 0.2, depth: 0.5, area: 1.72, discovered: '2019' },
    { id: 'D02', name: '裂缝 #02', type: '裂缝', position: '腹部右侧', level: 'general', color: '#3b82f6', length: 4.2, width: 0.1, depth: 0.2, area: 0.42, discovered: '2019' },
    { id: 'D03', name: '裂缝 #03', type: '裂缝', position: '腹部正面', level: 'danger', color: '#ef4444', length: 12.4, width: 0.3, depth: 0.8, area: 3.72, discovered: '2019' },
    { id: 'D04', name: '腐蚀区 #01', type: '腐蚀', position: '底部', level: 'severe', color: '#f97316', length: 15.0, width: 8.0, depth: 0.4, area: 120.0, discovered: '2015' },
    { id: 'D05', name: '剥落 #01', type: '剥落', position: '口沿', level: 'moderate', color: '#f59e0b', length: 3.0, width: 1.5, depth: 0.6, area: 4.5, discovered: '2020' },
    { id: 'D06', name: '裂缝 #04', type: '裂缝', position: '左耳根部', level: 'general', color: '#3b82f6', length: 2.8, width: 0.1, depth: 0.3, area: 0.28, discovered: '2023' },
  ],
  ...
  cases: [
    ...
    { id: 'C002', title: '西周铜簋潮湿环境保护方案', type: '青铜器', method: '纳米封护材料', year: '2021', similarity: '88%', effect: '优良', humidity: '控制后42%RH' },
  ...
  /* ====== 多模态档案资料 ====== */
  archives: [
    { type: 'text', title: '考古发掘报告（1974）', icon: 'fa-file-alt', desc: '茹家庄西周墓地发掘报告，含墓葬形制与出土器物清单' },
    { type: 'image', title: '文物细节特写（2024）', icon: 'fa-image', desc: '腹部兽面纹高清特写，含裂缝部位详细照片' },
    { type: 'data', title: '材质检测数据', icon: 'fa-chart-bar', desc: 'XRF成分分析：Cu 82.3%, Sn 14.2%, Pb 3.5%' },
    { type: 'text', title: '修复记录（1980）', icon: 'fa-file-alt', desc: '首次修复记录：腹部裂缝加固、锈蚀清理、封护处理' },
  ...
  aiPresets: {
    ...
    queryCase: {
      ...
      answer: '为您检索到5个同类案例。其中匹配度最高的是《西周铜簋潮湿环境保护方案》（相似度88%），该案例采用纳米封护材料进行加固，修复后湿度控制在42%RH，经过3年跟踪观察，修复效果评定为"优良"。建议优先参考该案例的材料选择与湿度控制方案。'
    },
    queryMaterial: {
  ...
  report: {
    ...
    sections: [
      { title: '一、文物基本信息', content: '详见全息档案，主要参数：西周中期青铜礼器，通高38.2cm，一级文物，1974年宝鸡茹家庄出土。' },
      { title: '二、裂缝发展分析', content: '核心裂缝(#03)位于腹部正面，2019年初始长度3.2cm，至2024年已扩展至12.4cm，年均增长约1.8cm。2022年雨季为关键加速期（单年增长4.4cm），与环境湿度持续超标（72%RH）高度相关。' },
